...
class IotResources:
    def __init__(self, scope: Construct, dynamo_table, certificate_arn: str):
        ...
        self.role.add_to_policy(
            iam.PolicyStatement(
                actions=["dynamodb:PutItem"], resources=[dynamo_table.table_arn]
            )
        )
        ...
        self.policy_principal_attachment = iot.CfnPolicyPrincipalAttachment(
            scope,
            "RetroPieStatsPolicyCertAttachment",
